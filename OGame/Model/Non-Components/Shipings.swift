...
struct Shipings {
    ...
    func interceptor(_ amount: Int = 1) -> (Int, Int, String) { return (215, amount, "shipyard") }
    ...
    func explorer(_ amount: Int = 1) -> (Int, Int, String) { return (219, amount, "shipyard") }
    func smallTransporter(_ amount: Int = 1) -> (Int, Int, String) { return (202, amount, "shipyard") }
    func largeTransporter(_ amount: Int = 1) -> (Int, Int, String) { return (203, amount, "shipyard") }
