...
struct Price {
    func get(technology: (type: Int, amount: Int, component: String), level: Int = 1) -> [Int] {
        ...
        if Buildings.isSupplies(technology)  {
            switch technology.type {
            case 1:
        ...
        if Buildings.isFacilities(technology) {
            switch technology.type {
            case 14:
            ...
            case 36:
                return resources(metal: 40 * pow(5, Double(level)), deuterium: 10 * pow(5, Double(level)))
            case 41:
        ...
        if Researchings.isResearch(technology) {
            switch technology.type {
            case 113:
