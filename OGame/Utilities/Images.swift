...
struct Images {
    ...
    struct Resources {
        ...
        struct Large {
            ...
            static let fusionPlant = UIImage(named: "fusionPlant")
    ...
    struct Facilities {
        ...
        struct Large {
            ...
            static let researchLaboratory = UIImage(named: "researchLaboratory")
            ...
            static let repairDock = UIImage(named: "repairDock")
    ...
    struct Researches {
        ...
        struct Large {
            ...
            static let ion = UIImage(named: "ion")
            static let hyperspace = UIImage(named: "hyperspace")
            static let plasma = UIImage(named: "plasma")
            ...
            static let espionage = UIImage(named: "espionage")
            static let computer = UIImage(named: "computer")
            static let astrophysics = UIImage(named: "astrophysics")
            static let researchNetwork = UIImage(named: "researchNetwork")
            static let graviton = UIImage(named: "graviton")
            static let weapons = UIImage(named: "weapons")
    ...
    struct Ships {
        ...
        struct Large {
            ...
            static let interceptor = UIImage(named: "battlecruiser")
            ...
            static let explorer = UIImage(named: "pathfinder")
            static let smallTransporter = UIImage(named: "smallCargo")
            static let largeTransporter = UIImage(named: "largeCargo")
        ...
        struct SmallAvailable {
            ...
            static let interceptor = UIImage(named: "battlecruiserAvailable")
            ...
            static let explorer = UIImage(named: "pathfinderAvailable")
            static let smallTransporter = UIImage(named: "smallCargoAvailable")
            static let largeTransporter = UIImage(named: "largeCargoAvailable")
        ...
        struct SmallUnavailable {
            ...
            static let interceptor = UIImage(named: "battlecruiserUnavailable")
            ...
            static let explorer = UIImage(named: "pathfinderUnavailable")
            static let smallTransporter = UIImage(named: "smallCargoUnavailable")
            static let largeTransporter = UIImage(named: "largeCargoUnavailable")
